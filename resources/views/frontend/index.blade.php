                ...
                <div class="tab-content tab-content-carousel">
                    <div class="tab-pane p-0 fade show active" id="products-featured-tab" role="tabpanel" aria-labelledby="products-featured-link">
                        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                         ...
                         @foreach($featuredProduct as $fproducts )


                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                   @if($fproducts->user->authorized == '1')
                                    ...
                                    <a href="{{url('single/'.$fproducts->category->slug.'/'.$fproducts->slug)}}">
                                        <img src="{{asset('assets/uploads/posts/'.$fproducts->image)}}" alt="Product image" style="height: 200px;"  class="product-image">
                                        <img src="{{asset('assets/uploads/posts/'.$fproducts->image)}}" alt="Product image" style="height: 200px;"  class="product-image-hover">
                                    </a>
                    ...
                    <div class="tab-pane p-0 fade" id="products-top-tab" role="tabpanel" aria-labelledby="products-top-link">
                        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                            ...
                            <div class="product product-11 text-center">
                                ...
                                <div class="product-body">
                                    <h3 class="product-title"><a href="{{url('categrylist')}}">Roots Sofa Bed</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                    ...
                                    <div class="col-6 col-sm-3 col-xs-5">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                ...
                                                <div class="product-action-vertical">
                                                    @if($post->wish_status == 0)
                                                    <a href="{{ url('updatewishlist'.$post->id)}}" class="btn-product-icon btn-wishlist btn-expandable"><span>add to wishlist</span></a>
                                                    @else
                                                    <a href="{{ url('updatewishlist'.$post->id)}}" class="btn-product-icon btn-wishlist btn-expandable"><span>add to wishlist</span></a>
                                                    @endif
