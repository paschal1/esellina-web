                    ...
                    <div class="row">
                        <div class="col-lg-9 col-xl-4-5col">
                            ...
                            <div class="cat-blocks-container">
                                <div class="row">
                                    {{-- @foreach ($posts->post as $shop) --}}
                                    {{-- <div class="col-6 col-md-4 col-lg-3"> --}}
                                        {{-- <a href="{{ url('single/'.$shop->category->slug.'/'.$shop->slug)}}" class="cat-block">
                                            <figure>
                                                <span style="height: 100px">
                                                    <img class="img-thumbnail" src="{{asset('assets/uploads/posts/'.$shop->image)}}" alt="Shop image">
                                                </span>
                                            </figure>

                                            <h4 class="cat-block-title">{{$shop->name}}</h4><!-- End .cat-block-title --> --}}
                                    ...
                                    <div class="col-6 col-md-4 col-xl-3">
                                        <div class="product">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{ url('single/'.$post->category->slug.'/'.$post->slug)}}">{{ $post->name}}</a></h3><!-- End .product-title -->
...
{{-- {{$post->onEachSide(1)->links()}} --}}
                        ...
                        <aside class="col-lg-3 col-xl-5col order-lg-first">
                            <div class="sidebar sidebar-shop">
                                ...
                                <div class="widget">
                                    <h3 class="widget-title">Products</h3><!-- End .widget-title -->

                                    <div class="widget-body">

                                        @foreach($posts->post as $postin)
                                        <div class="filter-items">
                                            <div class="filter-item">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="brand-1">
                                                    <label class="custom-control-label" for="brand-1"><a href="{{ url('single/'.$postin->category->slug.'/'.$postin->slug)}}">{{ $postin->name}}</a></label>
