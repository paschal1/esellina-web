                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <a href="{{ url('listallcate/'.$category->id)}}" class="cat-block">
                                            ...
                                            @if(Auth::user()->authorized == 0 && $category->user_id == Auth::user()->id)
                            ...
                            <div class="owl-carousel owl-simple owl-nav-top carousel-equal-height carousel-with-shadow" data-toggle="owl"
                                ...
                                <div class="product">
                                    <figure class="product-media">
                                        ...
                                        <a href="product.html">
                                            <img src="{{ asset('assets/uploads/posts/'.$featuredProduct->image )}}" alt="Product image" class="product-image">
                                        </a>
                                        ...
                                        <div class="product-action">
                                            <a href="{{ url('cart')}}" class="btn-product btn-cart" title="Add to cart"><span>add to cart</span></a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product.html">{{ $featuredProduct->small_description }}</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            {{ Helper::currency_converter($featuredProduct->selling_price) }}
                            ...
                            {{-- <div class="products mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-md-4 col-xl-3">
                                        <div class="product">
                                            <figure class="product-media">
                                                <span class="product-label label-new">Buy me</span>
                                                <a href="product.html">
                                                    <img src="{{ asset('assets/uploads/posts/'.$post->image)}}" alt="Product image" class="product-image">
                                                </a>
                                            ...
                                            <div class="product-body">
                                                <div class="product-cat">
                                                    <a href="{{ url('categorylist')}}">{{ $posts->category}}</a>
                                                </div><!-- End .product-cat -->
                                                <h3 class="product-title"><a href="{{ url('single/'.$category->slug.'/'.$post->slug)}}">{{ $post->name}}</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                    ...
                                    @else
                                     <p> No Product from this category</p>
                                    @endif
                                    @endforeach
                                </div><!-- End .row -->
                            </div><!-- End .products --> --}}
