...
<head>
    ...
    <meta name="author" content="esellina">
     <!-- CSRF Token -->
...
<footer class="footer footer-2">
        	...
        	<div class="footer-newsletter bg-image" style="background-image: url(molla/assets/images/backgrounds/bg-2.jpg)">
        		<div class="container">
	            				...
	            				<ul class="widget-list">
	            					...
	            					<li><a href="{{ url('contact_us')}}">Contact us</a></li>
                                     ...
                                     @if (Route::has('login'))
                                        ...
                                        @endif
                                   @else
                                  <li> <a href="#">you are logged in as {{ Auth::user()->name }}</a></li>
	        ...
	        <div class="footer-bottom">
	        	<div class="container">
	        		<p class="footer-copyright">Copyright © 2023 Esellina Store. All Rights Reserved.</p><!-- End .footer-copyright -->
                ...
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            <img src="{{ asset('molla/assets/images/logo.png')}}" class="logo" alt="logo" width="60" height="15">
...
<!-- molla/index-1.html  22 Nov 2023 09:55:32 GMT -->
</html>
