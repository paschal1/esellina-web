...
<head>
    ...
    <title>{{ config('app.name', 'Esellina') }}</title>
...
{{-- owlCarousel --}}
    <link href="{{ asset('frontend/css/material-dashboard.css?v=3.0.4') }}" rel="stylesheet">
    <link href="{{ asset('frontend/css/nucleo-icons.css') }}" rel="stylesheet">
...
<script type="text/javascript">
  ...
  <script src="{{asset('frontend/js/material-dashboard.min.js?v=3.0.4') }}"></script>
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
@if(session('status'))
<script>swal( "{{session('status')}}");</script>

@endif
    {{-- @vite(['frontend/css/bootsrap5.css', 'frontend/js/core/bootstrap.bundle.min.js']) --}}
    <script src="{{asset ('frontend/js/core/bootstrap.bundle.min.js') }}" defer></script>
</body>
</html>
