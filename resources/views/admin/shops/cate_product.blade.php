                    ...
                    <div class="row">
                        <div class="col-lg-9 col-xl-4-5col">
                            ...
                            <div class="cat-blocks-container">
                                <div class="row">
                                    @foreach ($shops->category as $category)
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <a href="{{ url('listallcate/'.$category->id)}}" class="cat-block">
                                            <figure>
                                                <span style="height: 100px">
                                                    <img class="img-thumbnail" src="{{asset('assets/uploads/category/'.$category->image)}}" alt="Shop image">
                                                </span>
                                            </figure>

                                            <h4 class="cat-block-title">{{$category->name}}</h4><!-- End .cat-block-title -->
                                            @if(Auth::user()->authorized == 0)
                                                        <span class="m-5">  <a href="{{ url('editshop/'.$category->id) }}"> <button  class="btn-sm btn-warning">update</button></a></span>
                                                        <span class="m-5">  <a href="{{ url('deleteshop'.$category->id) }}"> <button  class="btn-sm btn-danger">remove</button></a></span>
                                            @endif
                                        </a>
                            ...
                            <div class="owl-carousel owl-simple owl-nav-top carousel-equal-height carousel-with-shadow" data-toggle="owl"
                                ...
                                <div class="product">
                                    <figure class="product-media">
                                        ...
                                        <a href="product.html">
                                            <img src="{{ asset('molla/assets/images/demos/demo-13/products/product-7.jpg')}}" alt="Product image" class="product-image">
                                        </a>
                                ...
                                <div class="row">
                                    <div class="col-6 col-md-4 col-xl-3">
                                        <div class="product">
                                            <figure class="product-media">
                                                ...
                                                <a href="product.html">
                                                    <img src="{{ asset('molla/assets/images/demos/demo-13/products/product-6.jpg')}}" alt="Product image" class="product-image">
                                                </a>
                                    ...
                                    <div class="col-6 col-md-4 col-xl-3">
                                        <div class="product">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="{{ asset('molla/assets/images/demos/demo-13/products/product-8.jpg')}}" alt="Product image" class="product-image">
                                                </a>
                                    ...
                                    <div class="col-6 col-md-4 col-xl-3">
                                        <div class="product">
                                            <figure class="product-media">
                                                <span class="product-label label-new">New</span>
                                                <a href="product.html">
                                                    <img src="{{ asset('molla/assets/images/demos/demo-13/products/product-9.jpg')}}" alt="Product image" class="product-image">
                                                </a>
                                    ...
                                    <div class="col-6 col-md-4 col-xl-3">
                                        <div class="product">
                                            <figure class="product-media">
                                                ...
                                                <a href="product.html">
                                                    <img src="{{ asset('molla/assets/images/demos/demo-13/products/product-10.jpg')}}" alt="Product image" class="product-image">
                                                </a>
                                    ...
                                    <div class="col-6 col-md-4 col-xl-3">
                                        <div class="product">
                                            <figure class="product-media">
                                                <span class="product-label label-new">New</span>
                                                <a href="product.html">
                                                    <img src="{{ asset('molla/assets/images/demos/demo-13/products/product-11.jpg')}}" alt="Product image" class="product-image">
                                                </a>
                                    ...
                                    <div class="col-6 col-md-4 col-xl-3">
                                        <div class="product">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="{{ asset('molla/assets/images/demos/demo-13/products/product-12.jpg')}}" alt="Product image" class="product-image">
                                                </a>
                                    ...
                                    <div class="col-6 col-md-4 col-xl-3">
                                        <div class="product">
                                            <figure class="product-media">
                                                <span class="product-label label-sale">Sale</span>
                                                <a href="product.html">
                                                    <img src="{{ asset('molla/assets/images/demos/demo-13/products/product-13.jpg')}}" alt="Product image" class="product-image">
                                                </a>
                                                 ...
                                                 <div id="collapse-1" class="collapse show" data-parent="#widget-cat-acc">
                                                    <div class="collapse-wrap">
                                                        <ul>
                                                            ...
                                                            <li><a href="{{ url('single/'.$category->slug.'/'.$post->slug)}}">{{$post->name}}</a></li>
                                                            @endforeach
