                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    ...
                                    @if(Auth::user()->authorized > 0)
                                                <span class="product-label label-circle label-success"><img src="{{ asset('admin/img/icons/circle-check-solid.svg')}}" alt="user authorized"></span>
                                                @endif

                                    <a href="{{ url('single/'.$featuredProduct->category->slug.'/'.$featuredProduct->slug)}}">
                                        <img src="{{asset('assets/uploads/posts/'.$featuredProduct->image)}}" alt="Product image" style="height: 200px;"  class="product-image">
                                        <img src="{{asset('assets/uploads/posts/'.$featuredProduct->image)}}" alt="Product image" style="height: 200px;"  class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-body">
                                    <h3 class="product-title"><a href="{{ url('single/'.$featuredProduct->category->slug.'/'.$featuredProduct->slug)}}">{{ $featuredProduct->name}}</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        <span class="new-price">{{ Helper::currency_converter($featuredProduct->selling_price) }}</span>
                                        <span class="old-price">Was {{ Helper::currency_converter($featuredProduct->original_price) }}</span>
                         ...
                         @foreach($tproduct as $tproducts )
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                       <img src="{{asset('assets/uploads/posts/'.$tproducts->image)}}" alt="Product image" style="height: 200px;"  class="product-image">
                                        <img src="{{asset('assets/uploads/posts/'.$tproducts->image)}}" alt="Product image" style="height: 200px;"  class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-body">
                                    <h3 class="product-title"><a href="product.html">{{ $tproducts->name}}</a></h3><!-- End .product-title -->
                                    <div class="product-price">
...
<div class="py-5">
    <div class="container">
        <div class="row">
         ...
         <div class="products mb-3" style="padding: 20px;">
                                        ...
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                ...
                                                <div class="product-action-vertical">
                                                    ...
                                                    <a href="{{ url('chatify')}}" class="btn-product-icon btn-chat btn-expandable"><span>chat</span></a>
                                                    <a href="{{ url('single/'.$post->category->slug.'/'.$post->slug)}}" class="btn-product-icon btn-quickview" title="Quick view"><span>Quick view</span></a>
                                                    <a href="{{ url('single/'.$post->category->slug.'/'.$post->slug)}}" class="btn-product-icon btn-compare" title="Compare"><span>Compare</span></a>
                                                </div><!-- End .product-action-vertical -->

                                                <div class="product-action">
                                                    <a href="{{ url('single/'.$post->category->slug.'/'.$post->slug)}}" class="btn-product btn-cart"><span>add to cart</span></a>
                                                </div><!-- End .product-action -->
                                            </figure><!-- End .product-media -->

                                            <div class="product-body">
                                                <div class="product-cat">
                                                    <a href="{{ url('single/'.$post->category->slug.'/'.$post->slug)}}">{{$post->name}}</a>
                                                </div><!-- End .product-cat -->
                                                <h3 class="product-title"><a href="#">{{$post->description}}</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="{{ url('single/'.$post->category->slug.'/'.$post->slug)}}" class="active">
